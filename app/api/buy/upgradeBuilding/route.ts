...
export async function POST(request: Request): Promise<NextResponse>
{
    ...
    return ServerRequestFunctions.handlePlayerStateActionRequest((playerId: number, serverData: ServerDataType.ServerData) => ServerRequestFunctions.tryUpgradeBuildingLogic(playerId, serverData, clientRequest));
}
