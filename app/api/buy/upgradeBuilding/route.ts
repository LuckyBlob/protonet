...
export async function POST(request: Request): Promise<NextResponse>
{
    ...
    return ServerRequestFunctions.handlePlayerStateActionRequest((playerId: number, serverData: CoreType.ServerData) => ServerRequestFunctions.tryUpgradeBuildingLogic(playerId, serverData, clientRequest));
}
