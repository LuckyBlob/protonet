...
export async function POST(request: Request): Promise<NextResponse>
{
    ...
    return ServerRequestFunctions.handlePlayerStateActionRequest((playerId: number, serverData: ServerDataType.ServerData) => ServerRequestFunctions.trySendFleetLogic(playerId, serverData, clientRequest));
}
